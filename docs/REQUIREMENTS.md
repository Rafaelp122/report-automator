...
- **RN06 - Pluralização Dinâmica:** A substituição de sufixos de plural (ex: `{s}`) deve ser ativada sempre que o número de valores únicos extraídos para uma coluna for maior que 1.
